$(function () {
    ...
    const dialButtons = document.getElementById('dial-buttons').children;
    ...
    async function makeOutgoingCall() {
        ...
        if (device) {
            ...
            Array.prototype.forEach.call(dialButtons, element => {
                element.onclick = (event) => {
                    call.sendDigits(event.target.textContent)
                    log(`Clicked ${event.target.textContent}`)
                }
            });
